...
" Options
""""""""""""""""""""""""""""""""""""""""""""""""
let s:reduced = get(g:, 'airline_solarizedalt_reduced', 1)
let s:background = get(g:, 'airline_solarizedalt_bg', &background)
...
let g:airline#themes#solarizedalt#inactive = airline#themes#generate_color_map(
            \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]],
            \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]],
            \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]],
            \ s:NFa)

let g:airline#themes#solarizedalt#inactive_modified = {
            \ 'statusline': [s:NM.statusline[0].g, '', s:NM.statusline[0].t, '', ''] }

let g:airline#themes#solarizedalt#normal = airline#themes#generate_color_map(
            \ [s:N1[0].g, s:N1[1].g, s:N1[0].t, s:N1[1].t, s:N1[2]],
            \ [s:N2[0].g, s:N2[1].g, s:N2[0].t, s:N2[1].t, s:N2[2]],
            \ [s:N3[0].g, s:N3[1].g, s:N3[0].t, s:N3[1].t, s:N3[2]],
            \ s:NFa)

let g:airline#themes#solarizedalt#normal_modified = {
...
let g:airline#themes#solarizedalt#insert = airline#themes#generate_color_map(
            \ [s:I1[0].g, s:I1[1].g, s:I1[0].t, s:I1[1].t, s:I1[2]],
            \ [s:I2[0].g, s:I2[1].g, s:I2[0].t, s:I2[1].t, s:I2[2]],
            \ [s:I3[0].g, s:I3[1].g, s:I3[0].t, s:I3[1].t, s:I3[2]],
            \ s:IFa)

let g:airline#themes#solarizedalt#insert_modified = {
...
let g:airline#themes#solarizedalt#visual = airline#themes#generate_color_map(
...
let g:airline#themes#solarizedalt#visual_modified = {
